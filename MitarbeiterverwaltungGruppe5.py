...
while selection != 6:  # As long as the variable is not 6, the while loop will be running.
    ...
    if selection == 1:  # If the value of the variable is a 1, then this while loop will start.
        while selection != 4:  # The while loop is running, as long as not the number 4 is inserted.
            ...
            selection = int(
                input("Please enter a number between 1 and 4!  "))  # The user now can give a new value to the variable.

            if selection != 4:  # If any number except the number 4 is entered, then text below printed and submen agn
        ...
        while selection != 7:  # The while loop is running, as long as not the number 7 is inserted.
            ...
            selection = int(
                input("Please enter a number between 1 and 5!  "))  # The user now can give a new value to the variable.
            ...
            if selection == 3:  # If the value of the variable is a 2, then this while loop will start.
                while selection != 5:  # The while loop is running, as long as not the number 5 is inserted.
                    ...
                    selection = int(input(
                        "Please enter a number between 1 and 5!  "))  # The user can give a new value to the variable.
                    ...
                    if selection == 3:
                        a = input("Abteilung?:\n")
                        newdfa = df.query(
                            'Abteilung.str.contains(@a)')  # Filter nach Abteilung über die Übergabevariable @n
                        print(newdfa)

                    if selection == 4:
                        a = input("Krankenkasse?:\n")
                        newdfa = df.query(
                            'Krankenkasse.str.contains(@a)')  # Filter nach Krankenkasse über die Übergabevariable @n
                        print(newdfa)
            ...
            if selection == 5:
                df2 = (round(df["Alter"].mean(),
                             0))  # Ausgabe des Mittelwerts der Spalte Alter, mit Rundung auf eine Stelle
        ...
        selection = 1  # The variable is set to 1,cause if not the submenu would close cause the input to close
        while selection != 3:  # The while loop is running, as long as not the number 3 is inserted.
            ...
            selection = int(
                input("Please enter a number between 1 and 3!  "))  # The user now can give a new value to the variable.

            if selection != 3:  # If any number except the number 3 is entered, then text below printed and submen agn
                print("\n This function is not developed yet.\n")
        ...
        selection = 1  # The variable is set to 1, cause if not happen the submenu would close
        while selection != 4:  # The while loop is running, as long as not the number 4 is inserted.
            print("\n""1. delete all\n"
                  "2. delete single row\n"
            ...
            if selection != 4:  # If any num.except the 5 is inserted,then the text below and submenu displayed agn
                print("\n This function is not developed yet.\n")
